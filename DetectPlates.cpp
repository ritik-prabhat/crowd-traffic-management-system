...
using namespace std;
///////////////////////////////////////////////////////////////////////////////////////////////////
  vector<PossiblePlate> detectPlatesInScene(cv::Mat &imgOriginalScene) {
...
#ifdef SHOW_STEPS
      cout << "step 2 - vectorOfPossibleCharsInScene.Count = " << vectorOfPossibleCharsInScene.size() <<   endl;        // 131 with MCLRNF1 image
...
#ifdef SHOW_STEPS
      cout << "step 3 - vectorOfVectorsOfMatchingCharsInScene.size() = " << vectorOfVectorsOfMatchingCharsInScene.size() <<   endl;        // 13 with MCLRNF1 image
    ...
    for (unsigned int i = 0; i < vectorOfPossiblePlates.size(); i++) {
        ...
        cv::imshow("4a", imgContours);
          ...
          cout << "possible plate " << i << ", click on any image and press a key to continue . . ." <<   endl;

        cv::imshow("4b", vectorOfPossiblePlates[i].imgPlate);
        cv::waitKey(0);
    }
      cout <<   endl << "plate detection complete, click on any image and press a key to begin char recognition . . ." <<   endl <<   endl;
    cv::waitKey(0);
#endif    // SHOW_STEPS
...
///////////////////////////////////////////////////////////////////////////////////////////////////
  vector<PossibleChar> findPossibleCharsInScene(cv::Mat &imgThresh) {
...
#ifdef SHOW_STEPS
      cout <<   endl << "contours.size() = " << contours.size() <<   endl;                         // 2362 with MCLRNF1 image
      cout << "step 2 - intCountOfValidPossibleChars = " << intCountOfPossibleChars <<   endl;        // 131 with MCLRNF1 image
...
///////////////////////////////////////////////////////////////////////////////////////////////////
PossiblePlate extractPlate(cv::Mat &imgOriginal,   vector<PossibleChar> &vectorOfMatchingChars) {
